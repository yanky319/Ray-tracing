...
public class SphereTests {
    ...
    public void testFindIntersections() {
        ...
        assertEquals("Wrong Sphere findIntersections when Ray crosses sphere", List.of(p1, p2), result);
        // TC03: Ray starts inside the sphere (1 point)
        assertEquals("Wrong Sphere findIntersections when Ray starts inside sphere",
                List.of(new Point3D(0.5 + ((Math.sqrt(390) + 3 * Math.sqrt(10)) / 20) * 3 / Math.sqrt(10), ((Math.sqrt(390) + 3 * Math.sqrt(10)) / 20) * 1 / Math.sqrt(10), 0)),
        ...
        if (result.get(0).get_x().get() > result.get(1).get_x().get())
            result = List.of(result.get(1), result.get(0));
        assertEquals("Wrong Sphere findIntersections when Ray starts before the sphere and goes through the center", List.of(p1, p2), result);
        ...
        assertEquals("Wrong Sphere findIntersections when Ray starts at sphere center", List.of(p2),
